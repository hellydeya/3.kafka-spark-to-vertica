...
if __name__ == "__main__":    
    ...
    parser.add_argument("-ks", dest="kafka_server", default='hello', type=str, required=True)
    parser.add_argument("-kp", dest="kafka_port", default='hello', type=int, required=True)
    parser.add_argument("-kt", dest="kafka_topic", default='hello', type=str, required=True)
    parser.add_argument("-kc", dest="kafka_cert", default='hello', type=str, required=True)
    parser.add_argument("-ku", dest="kafka_username", default='hello', type=str, required=True)
    parser.add_argument("-kpas", dest="kafka_password", default='hello', type=str, required=True)
    parser.add_argument("-ps", dest="postgres_server", default='hello', type=str, required=True)
    parser.add_argument("-pp", dest="postgres_port", default=hello, type=int, required=True)
    parser.add_argument("-pd", dest="postgres_db", default='hello', type=str, required=True)
    parser.add_argument("-ptc", dest="postgres_tbl_c", default='hello', type=str, required=True)
    parser.add_argument("-ptt", dest="postgres_tbl_t", default='hello', type=str, required=True)
    parser.add_argument("-pu", dest="postgres_user", default='hello', type=str, required=True)
    parser.add_argument("-ppas", dest="postgres_password", default='hello', type=str, required=True)
    parser.add_argument("-td", dest="temp_dir", default='hello', type=str, required=False)
